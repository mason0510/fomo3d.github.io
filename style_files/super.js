...
function superInit(){
	...
	window.testInjectLanguage = setInterval(function(){
		...
		$('a.navbar-brand').html('<img src="/img/dark-logo.png" style="height:1.5rem;" /><img src="/img/' + window.lang + '.png" style="height:1.5rem" />')
	...
	window.testStatTab = setInterval(function(){
		...
		$('#statTabs').parent().append(`
			...
			超级FOMO游戏为了做到公平公正，引入了一个防止他人大量购买key数量的抑制机制，在游戏萌芽期（总购买钥匙金额小于100ETH），当有玩家购买钥匙金额超过1ETH时，将触发这个机制。抑制机制触发后，每个玩家购买钥匙总金额不得超过1ETH，这也是为了保护后期进入游戏的玩家，防止早期有玩家大量买入钥匙导致游戏结束后分红大量流入这些玩家。在游戏总购买钥匙金额超过100ETH后，游戏将进入繁荣期，每个玩家能够购买key数量将随着游戏总钥匙卖出金额增加。根据这个机制，可以尽可能保证每个玩家都能公平的获得收益。例如，在游戏萌芽期，Tom买入了2ETH的key，这个时候，将触发抑制机制，每个玩家购买key金额不得超过1ETH，当游戏总钥匙卖出金额超过100ETH时，游戏进入繁荣期，这个时候，每个人购买key数量将逐渐增加。
			</div>
			</div>
			</div>
			</div>
	...
	if(window.lang == 'zh'){
		window.languageSwitcher = '<div class="col-auto"><span class="lead small"><a href="//en.fomosuper.me/play">En</a></span></div><div class="col-auto"><span class="lead small"><a href="https://t.me/fomosuper" target="_blank">电报群</a></span></div><div class="col-auto"><span class="lead small"><a href="http://weibo.com/u/6585834305" target="_blank">微博</a></span></div><div class="col-auto"><span class="lead small"><a href="manual.pdf" target="_blank">教程</a></span></div><div class="col-auto"><span class="lead small"><a href="https://etherscan.io/address/0x8c74f1ed536e79de5cb225f035bc989ae84493f7#code" target="_blank">合约</a></span></div>';
	} else {
		window.languageSwitcher = '<div class="col-auto"><span class="lead small"><a href="//www.fomosuper.me/play">中文</a></div><div class="col-auto"><span class="lead small"><a href="https://t.me/fomosuper" target="_blank">Telegram</a></span></div><div class="col-auto"><span class="lead small"><a href="http://weibo.com/u/6585834305" target="_blank">Weibo</a></span></div><div class="col-auto"><span class="lead small"><a href="https://etherscan.io/address/0x8c74f1ed536e79de5cb225f035bc989ae84493f7#code" target="_blank">Contract</a></span></div>';
	}
}
...
function makeUrl(value, gas){
	var address = '0x8C74f1eD536e79De5CB225f035bc989aE84493F7';
